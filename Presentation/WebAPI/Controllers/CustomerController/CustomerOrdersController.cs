...
namespace badmintion.Controllers.CustomerController
{
    ...
    [Route("api/Customer/Oders")]
    public class CustomerOrdersController : DefaultReposityController<Order>
    {
        private readonly IOdersService _service;
        public CustomerOrdersController(BadmintionNlContext context, IOdersService service, IHttpContextAccessor httpContextAccessor) : base(context, DefaultNameCollection.ORDERS, httpContextAccessor)
        {
            _service = service;
        }
        [HttpPost]
