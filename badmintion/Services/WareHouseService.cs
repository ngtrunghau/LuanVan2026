    ...
    public class WareHouseService : IWareHouseService
    {
        ...
        public async Task<dynamic> Create(WareHouseDTO model)
        {
            try
            {
                ...
                var existingCustomer = await _context.Products.FindAsync(model.ProductId);
                ...
                if (ware == null)
                {
                    ...
                    existingCustomer.StockQuantity = model.QuantityImport;
                ...
                else
                {
                    ...
                    existingCustomer.StockQuantity = ware.RemainQuantity;
                }
