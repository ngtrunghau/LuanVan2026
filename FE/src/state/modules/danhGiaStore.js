...
const controller = "ProductReview";
...
export const actions = {
    ...
    async getAllCustomer({commit}) {
        return apiClient.get("Customer/" + controller + "/get-all-core");
    },
    ...
    async getByIdCustomer({commit}, id) {
        return apiClient.post("Customer/" + controller +"/get-by-id-core", id);
    },
