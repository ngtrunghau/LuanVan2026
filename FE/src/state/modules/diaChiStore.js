...
const controller = "AddressCustomer";
...
export const actions = {
    ...
    async getAddress({commit}, params) {
        return apiClient.post(controller +"/get-address-by-id-user", params);
    },
    async getAddressCustomer({commit}, params) {
        return apiClient.post("Customer/" + controller +"/get-address-by-id-user", params);
    },
