    ...
    <li class="has-submenu" :class="adminMenu ? 'active' : 'notactive'">
      ...
      <ul class="submenu" :style="{ display: isVisibleadmin ? 'block' : 'none' }">
        <li :class="currentPath == 'admin/index' ? 'active' : 'notactive'">
          <router-link to="/quan-tri" target="_blank">Admin</router-link>
        </li>
        <li :class="currentPath == '/quan-tri' ? 'active' : 'notactive'">
          <router-link to="/quan-tri" target="_blank">Pharmacy Admin</router-link>
        </li>
      </ul>
    </li>
    <li class="login-link">
