namespace badmintion.Lib.Core.DefaultRepository
{
    public static class DefaultCode
    {
        ...
        public const int CREATE_SUCCESS = 1; // Thành công 


        public const int UPDATE_SUCCESS = 2; // Thành công 

        public const int DELETE_SUCCESS = 3; // Thành công 
        public const int GET_SUCCESS = 4; // Thành công 

        public const int LOGIN_SUCCESS = 5; // Thành công 
        ...
        public const int TOTAL_BXH = 32; // Một số trường data sai quy định 


        public const int ID_NOT_CORRECT_FORMAT = 28; // Một số trường data sai quy định 


        public const int NOT_HAVE_ACCESS = 29; // Một số trường data sai quy định 


        public const int CORRECT_NUMBER_QUESTION = 30; // Một số trường data sai quy định 

        public const int OVER_TIME = 31; // Một số trường data sai quy định 


        public const int TIME_SEU = 33; // Chưa đến thời gian thi

        public const int VERSION_INCORRECT = 34;
        public const int HET_THOI_GIAN = 35;
        public const int CAUTRUCDETHI = 36;
